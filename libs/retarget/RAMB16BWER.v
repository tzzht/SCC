...
// \   \  /  \    Timestamp : Thu Jul 13 2:16:20 PST 2009
//  \___\/\___\
//
// Revision:
...
RAMB36E1 #(.DOA_REG(DOA_REG), .DOB_REG(DOB_REG), .INIT_A(INIT_A), .INIT_B(INIT_B), .INIT_FILE(INIT_FILE), .RSTREG_PRIORITY_A(rstreg_priority_a_int), .RSTREG_PRIORITY_B(rstreg_priority_b_int), .SRVAL_A(SRVAL_A), .SRVAL_B(SRVAL_B), .WRITE_MODE_A(WRITE_MODE_A), .WRITE_MODE_B(WRITE_MODE_B), .READ_WIDTH_A(DATA_WIDTH_A), .READ_WIDTH_B(DATA_WIDTH_B), .WRITE_WIDTH_A(DATA_WIDTH_A), .WRITE_WIDTH_B(DATA_WIDTH_B), .SIM_COLLISION_CHECK(SIM_COLLISION_CHECK), .INIT_00(INIT_00), .INIT_01(INIT_01), .INIT_02(INIT_02), .INIT_03(INIT_03), .INIT_04(INIT_04), .INIT_05(INIT_05), .INIT_06(INIT_06), .INIT_07(INIT_07), .INIT_08(INIT_08), .INIT_09(INIT_09), .INIT_0A(INIT_0A), .INIT_0B(INIT_0B), .INIT_0C(INIT_0C), .INIT_0D(INIT_0D), .INIT_0E(INIT_0E), .INIT_0F(INIT_0F), .INIT_10(INIT_10), .INIT_11(INIT_11), .INIT_12(INIT_12), .INIT_13(INIT_13), .INIT_14(INIT_14), .INIT_15(INIT_15), .INIT_16(INIT_16), .INIT_17(INIT_17), .INIT_18(INIT_18), .INIT_19(INIT_19), .INIT_1A(INIT_1A), .INIT_1B(INIT_1B), .INIT_1C(INIT_1C), .INIT_1D(INIT_1D), .INIT_1E(INIT_1E), .INIT_1F(INIT_1F), .INIT_20(INIT_20), .INIT_21(INIT_21), .INIT_22(INIT_22), .INIT_23(INIT_23), .INIT_24(INIT_24), .INIT_25(INIT_25), .INIT_26(INIT_26), .INIT_27(INIT_27), .INIT_28(INIT_28), .INIT_29(INIT_29), .INIT_2A(INIT_2A), .INIT_2B(INIT_2B), .INIT_2C(INIT_2C), .INIT_2D(INIT_2D), .INIT_2E(INIT_2E), .INIT_2F(INIT_2F), .INIT_30(INIT_30), .INIT_31(INIT_31), .INIT_32(INIT_32), .INIT_33(INIT_33), .INIT_34(INIT_34), .INIT_35(INIT_35), .INIT_36(INIT_36), .INIT_37(INIT_37), .INIT_38(INIT_38), .INIT_39(INIT_39), .INIT_3A(INIT_3A), .INIT_3B(INIT_3B), .INIT_3C(INIT_3C), .INIT_3D(INIT_3D), .INIT_3E(INIT_3E), .INIT_3F(INIT_3F), .INITP_00(INITP_00), .INITP_01(INITP_01), .INITP_02(INITP_02), .INITP_03(INITP_03), .INITP_04(INITP_04), .INITP_05(INITP_05), .INITP_06(INITP_06), .INITP_07(INITP_07)) R1 (.CASCADEOUTA(), .CASCADEOUTB(), .DBITERR(), .SBITERR(), .DOADO(DOA), .DOBDO(DOB), .DOPADOP(DOPA), .DOPBDOP(DOPB), .ECCPARITY(), .RDADDRECC(), .ADDRARDADDR({2'b0, ADDRA}), .ADDRBWRADDR({2'b0, ADDRB}), .CASCADEINA(1'b0), .CASCADEINB(1'b0), .CLKARDCLK(CLKA), .CLKBWRCLK(CLKB), .DIADI(DIA), .DIBDI(DIB), .DIPADIP(DIPA), .DIPBDIP(DIPB), .ENARDEN(ENA), .ENBWREN(ENB), .INJECTDBITERR(1'b0), .INJECTSBITERR(1'b0), .REGCEAREGCE(REGCEA), .REGCEB(REGCEB), .RSTRAMARSTRAM(RSTA), .RSTRAMB(RSTB), .RSTREGARSTREG(RSTA), .RSTREGB(RSTB), .WEA(WEA), .WEBWE({WEB[3:0], WEB[3:0]})); 
end
else if ((DATA_WIDTH_A <= 18) || (DATA_WIDTH_B <= 18)) begin
RAMB18E1 #(.DOA_REG(DOA_REG), .DOB_REG(DOB_REG), .INIT_A(INIT_A[17:0]), .INIT_B(INIT_B[17:0]), .INIT_FILE(INIT_FILE), .SRVAL_A(SRVAL_A[17:0]), .SRVAL_B(SRVAL_B[17:0]), .WRITE_MODE_A(WRITE_MODE_A), .WRITE_MODE_B(WRITE_MODE_B), .READ_WIDTH_A(DATA_WIDTH_A), .READ_WIDTH_B(DATA_WIDTH_B), .WRITE_WIDTH_A(DATA_WIDTH_A), .WRITE_WIDTH_B(DATA_WIDTH_B), .SIM_COLLISION_CHECK(SIM_COLLISION_CHECK), .RSTREG_PRIORITY_A(rstreg_priority_a_int), .RSTREG_PRIORITY_B(rstreg_priority_b_int), .INIT_00(INIT_00), .INIT_01(INIT_01), .INIT_02(INIT_02), .INIT_03(INIT_03), .INIT_04(INIT_04), .INIT_05(INIT_05), .INIT_06(INIT_06), .INIT_07(INIT_07), .INIT_08(INIT_08), .INIT_09(INIT_09), .INIT_0A(INIT_0A), .INIT_0B(INIT_0B), .INIT_0C(INIT_0C), .INIT_0D(INIT_0D), .INIT_0E(INIT_0E), .INIT_0F(INIT_0F), .INIT_10(INIT_10), .INIT_11(INIT_11), .INIT_12(INIT_12), .INIT_13(INIT_13), .INIT_14(INIT_14), .INIT_15(INIT_15), .INIT_16(INIT_16), .INIT_17(INIT_17), .INIT_18(INIT_18), .INIT_19(INIT_19), .INIT_1A(INIT_1A), .INIT_1B(INIT_1B), .INIT_1C(INIT_1C), .INIT_1D(INIT_1D), .INIT_1E(INIT_1E), .INIT_1F(INIT_1F), .INIT_20(INIT_20), .INIT_21(INIT_21), .INIT_22(INIT_22), .INIT_23(INIT_23), .INIT_24(INIT_24), .INIT_25(INIT_25), .INIT_26(INIT_26), .INIT_27(INIT_27), .INIT_28(INIT_28), .INIT_29(INIT_29), .INIT_2A(INIT_2A), .INIT_2B(INIT_2B), .INIT_2C(INIT_2C), .INIT_2D(INIT_2D), .INIT_2E(INIT_2E), .INIT_2F(INIT_2F), .INIT_30(INIT_30), .INIT_31(INIT_31), .INIT_32(INIT_32), .INIT_33(INIT_33), .INIT_34(INIT_34), .INIT_35(INIT_35), .INIT_36(INIT_36), .INIT_37(INIT_37), .INIT_38(INIT_38), .INIT_39(INIT_39), .INIT_3A(INIT_3A), .INIT_3B(INIT_3B), .INIT_3C(INIT_3C), .INIT_3D(INIT_3D), .INIT_3E(INIT_3E), .INIT_3F(INIT_3F), .INITP_00(INITP_00), .INITP_01(INITP_01), .INITP_02(INITP_02), .INITP_03(INITP_03), .INITP_04(INITP_04), .INITP_05(INITP_05), .INITP_06(INITP_06), .INITP_07(INITP_07)) R1 (.DOADO(DOA[15:0]), .DOBDO(DOB[15:0]), .DOPADOP(DOPA[1:0]), .DOPBDOP(DOPB[1:0]), .ADDRARDADDR(ADDRA[13:0]), .ADDRBWRADDR(ADDRB[13:0]), .CLKARDCLK(CLKA), .CLKBWRCLK(CLKB), .DIADI(DIA[15:0]), .DIBDI(DIB[15:0]), .DIPADIP(DIPA[1:0]), .DIPBDIP(DIPB[1:0]), .ENARDEN(ENA), .ENBWREN(ENB), .REGCEAREGCE(REGCEA), .REGCEB(REGCEB), .RSTRAMARSTRAM(RSTA), .RSTRAMB(RSTB), .RSTREGARSTREG(RSTA), .RSTREGB(RSTB), .WEA(WEA[1:0]), .WEBWE(WEB));
    end
  endgenerate
endmodule
